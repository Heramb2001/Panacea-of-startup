...
def donate(request):
    ...
    Client = razorpay.Client(auth=('rzp_test_dzqOTGViiQJgON' , 'fcpuaIHuRJUUevZ9SrpfBdb3'))
    payment = Client.order.create({'amount' : amount * 100 , 'currency' : 'INR' , 'payment_capture' : 1} )
    payment_order_id = payment['id']

    context = {'amount' : amount , 'api_key' : 'rzp_test_dzqOTGViiQJgON' , 'order_id' : payment_order_id}
    print(payment)
